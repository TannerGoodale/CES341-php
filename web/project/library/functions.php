...
function checkPrice($invPrice){
 ...
 function createNav($categories){
    ...
    $navList .= "<li><a href='/project/products/?action=category&categoryName=".urlencode($category['categoryname'])."' title='View our $category[categoryname]'>$category[categoryname]</a></li>";
    }
    $navList .= '</ul>';
    return $navList;
 }
