...
<body class="container-fluid">
        ...
        <div class="container-md">
            ...
            <p class="h4 text-center">You have been in the following places: <span class="h4 text-muted"> <?php if(isset($placesCoded)){echo $placesCoded;}else echo $placesMessage; ?></span></p>
